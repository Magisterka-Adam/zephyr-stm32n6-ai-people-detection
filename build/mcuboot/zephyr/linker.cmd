...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0x34180400, LENGTH = (0x40000 - 0x0)
    RAM (wx) : ORIGIN = 0x34180400, LENGTH = (511 * 1K)
    AXISRAM1 ( rw ) : ORIGIN = (872415232), LENGTH = (2097152) AXISRAM2 ( rw ) : ORIGIN = (873989120), LENGTH = (523264) PSRAM ( rw ) : ORIGIN = (2415919104), LENGTH = (33554400)
